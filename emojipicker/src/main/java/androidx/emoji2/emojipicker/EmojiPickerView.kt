...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
    ...
    init {
        ...
        usedInSearchResult = typedArray.getBoolean(R.styleable.EmojiPickerView_usedInSearchResult, false)
        typedArray.recycle()
    ...
    public fun createEmojiPickerBodyAdapter(): EmojiPickerBodyAdapter {
